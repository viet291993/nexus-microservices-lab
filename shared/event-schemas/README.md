...
-   Các **Topics** Kafka mà hệ thống sử dụng (`saga-orders-topic`, `saga-inventory-response`).
-   Các **Events** được truyền tải (`OrderCreated`, `InventoryConfirmed`, `InventoryFailed`).
